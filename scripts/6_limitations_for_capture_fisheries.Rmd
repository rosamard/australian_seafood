...
world_shp_2 <- rnaturalearth::ne_coastline(scale = 50, returnclass = "sf")
...
ggplot()+
  ...
  geom_tile(data = aus_fishing_aus_df, aes(x=x,y=y, fill=(aus_industrial_fishing)))+
   
  geom_sf(data= sf::st_crop(aus_shp , c(xmin = 110, xmax=160, ymin = -42, ymax=-7)), fill="lemonchiffon2", colour="black", size=0.1)+
  geom_sf(data= sf::st_crop(x=world_shp_2,  y=c(xmin = 70, xmax=180, ymin = -42, ymax=12)), colour="black", size=0.2)+
...
ggsave(here("explore/cottrell_explore/spatialised_landings.jpg"), width = 8, height = 6.7, units = "cm")
