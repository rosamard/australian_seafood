...
#Feed conversion ratios (FCR) are generally high around 15–20:1 for large specimens and 10–15:1 for smaller fish.  As a result only a small fraction (5 percent) of the total energy input is used for body growth (Korsmeyer and Dewars, 2001).
aqu_aus_3 <- aqu_aus_2 %>% 
